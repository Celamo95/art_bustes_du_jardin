...
<main>
    ...
    <section class="services">
        <div class="carte-service conception">
            <img src="images/conception.jpg" alt="dessin de jardin">
            <h3>Conception de jardin</h3>
            <p>Conception personnalisée pour un jardin unique</p>
            <a href="#description-conception" class="btn">Plus d'informations</a>
        </div>

        <div class="carte-service amenagement">
            <img src="images/amenagement.jpg" alt="photo de jardin aménagé">
            <h3>Aménagement de jardin</h3>
            <p>Transformez vos espaces avec créativité et fonctionnalité</p>
            <a href="#description-amenagement" class="btn">Plus d'informations</a>
        </div>

        <div class="carte-service entretien">
            <img src="images/entretien.jpg" alt="photo d'un arrosage">
            <h3>Entretien de jardin</h3>
            <p>Entretien complet pour un jardin impeccable</p>
            <a href="#description-entretien" class="btn">Plus d'informations</a>
        </div>

        <div class="carte-service chenilles">
            <img src="images/chenilles.jpg" alt="photo d'une chenille processionnaire">
            <h3>Lutte contre les chenilles processionnaires</h3>
            <p>La lutte contre les chenilles processionnaires</p>
            <a href="#description-chenilles" class="btn">Plus d'informations</a>
        </div>
